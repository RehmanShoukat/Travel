...
// const Hero = () => {
//   return (
//     <section className="relative w-full h-[99vh] flex flex-col items-center justify-center overflow-hidden pt-40 md:pt-0 px-4 sm:px-6">
...
//                        rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4 mx-4 sm:mx-6 md:mx-auto">
...
//           <input
//             type="date"
//             className="w-full p-3 text-center sm:text-left rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
//           />
//         </div>
